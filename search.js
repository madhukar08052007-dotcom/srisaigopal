...
(function() {
  ...
  /**
   * Fires a badge analytics event to the backend (fire-and-forget)
   */
  function trackBadgeEvent(
    platformUrl: string,
    appId: string,
    event: string,
    ...
    fetch(`${platformUrl}/api/apps/public/badge/${appId}/events`, {
      ...
      // Silently fail - analytics must never break the badge
    });
  }
